...
def register():
    ...
    if request.method == 'POST' and 'username' in request.form and 'firstname' in request.form and 'lastname' in request.form and 'password' in request.form and 'usertype' in request.form:
        # Create variables for easy access
        ...
        if account:
            ...
            msg = 'Usertype must be "Admin", "Mechanic", "Driver"!'

        elif not username or not password or not usertype or not firstname or not lastname:
            msg = 'Please fill out the form!'
        else:
        # Account doesnt exists and the form data is valid, now insert new account into accounts table
            cursor.execute('INSERT INTO USER (UserName, FirstName, LastName,HashPwd, UserType) VALUES ( \"%s\", \"%s\", \"%s\", \"%s\", \"%s\")' %(username, firstname, lastname, password, usertype,))
