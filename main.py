...
def register():
    ...
    if request.method == 'POST' and 'UserName' in request.form and 'FirstName' in request.form and 'LastName' in request.form and 'HashPwd' in request.form and 'UserType' in request.form:
        # Create variables for easy access
